...
<p align="center"> Given the increase in surveillance, we developed a Node based  MVC solution to provide users with a form of anonymous communication.
...
```
## :heavy_plus_sign: Dependencies  <a name = "dependencies"></a>
{
